...
$(call add_json_bool, Build_pixelgapps, $(filter true,$(TARGET_BUILD_PIXELGAPPS)))
$(call add_json_bool, Build_pixelgapps_gcam, $(filter true,$(TARGET_BUILD_PIXELGAPPS_GCAM)))
